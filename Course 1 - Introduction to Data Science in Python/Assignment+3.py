...
def answer_three():
    Top15 = answer_one()
    avg = Top15.loc[:,'2006':'2015'].mean(axis=1)
    avgGDP = avg.sort_values(axis=0, ascending=False)
    return avgGDP
...
def answer_four():
    Top15 = answer_one()
    Cty6 = answer_three().index[5]
    ans4 = Top15.loc[Cty6,'2015'] - Top15.loc[Cty6,'2006']
    return ans4 
...
def answer_five():
    Top15 = answer_one()
    ans5 = Top15.loc[:,'Energy Supply per Capita'].mean(axis=0)
    return ans5
...
def answer_six():
    Top15 = answer_one()
    ansNum = Top15.loc[:,'% Renewable'].max()
    # Top15.loc[Top15['% Renewable'].argmax(), '% Renewable'] 
    #Top15.loc[:,'% Renewable'].idxmax()
    tup6 = (Top15.loc[:,'% Renewable'].idxmax(),ansNum);
    return tup6
...
def answer_seven():
    Top15 = answer_one()
    Top15 = Top15.assign(ratio=Top15['Self-citations']/Top15['Citations'])
    name = Top15.loc[:,'ratio'].idxmax()
    rt = Top15.loc[:,'ratio'].max()
    #TOP15['Ratio'] = Top15[]/
    tup7 = (name, rt);
    return tup7
...
def answer_eight():
    Top15 = answer_one()
    Top15 = Top15.assign(estim=Top15['Energy Supply']/Top15['Energy Supply per Capita'])
    #Top15.loc[:,'estim'].index(2)
    ans8 = Top15.loc[:,'estim'].sort_values(axis=0, ascending=False).index[2]
    return ans8
...
def answer_nine():
    Top15 = answer_one()
    Top15['estim'] = Top15.iloc[:,7]/Top15.iloc[:,8]
    Top15['citDoc'] = Top15.iloc[:,2]/Top15['estim']
    ans9 = Top15[['citDoc','Energy Supply per Capita']].corr(method='pearson').iloc[0,0]
    return ans9
...
def answer_ten():
    Top15 = answer_one()
    Top15['HighRenew']  = 1 
    median = Top15.iloc[:,9].median()
    Top15.loc[Top15.iloc[:,9]<median,'HighRenew']  = 0
